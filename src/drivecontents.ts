...
export class GoogleDriveContents implements IContents  {
    ...
    private _save_existing(resource, model) {
        ...
        if (resource['headRevisionId'] !=
            this._last_observed_revision[resource['id']]) {
    ...
    get(path:string, options:any) {
        ...
        var contents_prm = metadata_prm.then((resource) => {
            this._observe_file_resource(resource);
...
export class Contents extends GoogleDriveContents {}
